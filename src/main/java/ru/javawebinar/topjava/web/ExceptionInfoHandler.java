...
public class ExceptionInfoHandler {
    ...
    public ErrorInfo conflict(HttpServletRequest req, DataIntegrityViolationException e) {
        return logAndGetErrorInfo(req, e, false, DATA_ERROR,
                messageSource.getMessage("user.duplicatedEmail", null, LocaleContextHolder.getLocale()));
    }
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... detail) {
        ...
        return detail != null ? new ErrorInfo(req.getRequestURL(), errorType, detail[0]) :
         new ErrorInfo(req.getRequestURL(), errorType, rootCause.toString());
    }
}