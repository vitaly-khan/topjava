...
<section>
    ...
    <form method="get" action="filter_meal">
        <dl>
    ...
    <hr/>
    <a href="create_meal"><spring:message code="common.add"/></a>
    <br><br>
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${meals}" var="meal">
            ...
            <tr data-mealExcess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="update_meal?id=${meal.id}">Update</a></td>
                <td><a href="delete_meal?id=${meal.id}">Delete</a></td>
            </tr>
        </c:forEach>
    </table>
</section>
